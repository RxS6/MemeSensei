    ...
    return (
      <section className="max-w-4xl mx-auto mt-12">
        ...
        <div className="text-center py-12">
          ...
          <p className="text-slate-500">No recent memes yet</p>
        </div>
      </section>
    );
  }
  ...
  return (
    <section className="max-w-4xl mx-auto mt-12">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {memes.map((meme) => (
          <Card key={meme.id} className="bg-white shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow duration-200">
            {meme.memeUrl ? (
              <img 
                src={meme.memeUrl} 
                alt="Recent meme" 
            ...
            <CardContent className="p-4">
              ...
              <p className="text-sm text-slate-600 line-clamp-3" data-testid={`text-recent-explanation-${meme.id}`}>
